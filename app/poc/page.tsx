  ...
  return (
    <main>
      ...
      <TestimonialsSection
        ...
        subtitle="Retours de fondateurs et décideurs qui ont validé leur hypothèse avec nous."
        accentColor="#34d399"
        testimonials={[
          {
          ...
          {
            label: "[Testimonial Investisseur]",
            quote:
              "Le POC nous a permis de valider l'hypothèse produit en 2 semaines. On a levé notre seed round avec la démo qu'ils ont livrée.",
            author: "Prénom N., Rôle, Entreprise (placeholder)",
          },
          {
            label: "[Testimonial Directeur Produit]",
            quote:
              "On pensait avoir besoin de 3 mois. Ils ont prouvé le concept en 3 semaines avec un prototype que nos clients ont pu tester immédiatement.",
            author: "Prénom N., Rôle, Entreprise (placeholder)",
          },
          {
            label: "[Testimonial CTO Startup]",
            quote:
              "Le livrable n'était pas juste une maquette — c'était un vrai prototype fonctionnel avec de la vraie data. Exactement ce qu'il nous fallait pour convaincre.",
            author: "Prénom N., Rôle, Entreprise (placeholder)",
          },
          {
            label: "[Testimonial Cofondateur]",
            quote:
              "Ils ont su dire non aux features inutiles et oui aux bonnes questions. Le POC a recentré toute notre stratégie produit.",
            author: "Prénom N., Rôle, Entreprise (placeholder)",
          },
          {
            label: "[Testimonial Head of Product]",
            quote:
              "La rapidité d'exécution est impressionnante, mais c'est la qualité du cadrage initial qui fait vraiment la différence. Rien n'a été à jeter.",
            author: "Prénom N., Rôle, Entreprise (placeholder)",
          },
          {
            label: "[Testimonial Associé]",
            quote:
              "On a montré le POC à nos partenaires le lendemain de la livraison. Leur réaction a confirmé qu'on tenait le bon concept.",
            author: "Prénom N., Rôle, Entreprise (placeholder)",
          },
        ]}
      />
