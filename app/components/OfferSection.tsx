...
const CARD_BASE =
  "card-depth border border-white/[0.07] border-t-white/[0.13] rounded-2xl transition-all duration-300 hover:border-white/[0.12] hover:border-t-white/[0.2]";
    ...
    <section className="py-16 md:py-28 px-6 md:px-20">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="relative">
          <div
            className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[500px] rounded-full pointer-events-none -z-10"
            style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
            {/* ── Hero Card ── */}
            <article
              className="md:col-span-2 relative overflow-hidden border border-white/[0.08] border-t-white/[0.16] rounded-2xl p-8 md:p-10 flex flex-col gap-7 transition-all duration-300 hover:border-white/[0.14] hover:border-t-white/[0.24]"
              style={{
                background:
                  "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.025) 100%)",
                boxShadow: `0 0 120px -20px ${accent}30`,
              }}
            >
              {/* Inner radial glow from accent */}
              <div
                className="absolute inset-0 pointer-events-none"
                style={{
                  background: `radial-gradient(ellipse at top, ${accent}10 0%, transparent 55%)`,
                }}
              />
              {/* Top accent line */}
              <div
            ...
            {/* ── Timeline & Budget ── */}
            <article className={`${CARD_BASE} relative p-7 md:p-8 flex flex-col`}>
            ...
            {/* ── Périmètre ── */}
            <article className={`${CARD_BASE} relative p-7 md:p-8 flex flex-col gap-5`}>
            ...
            {/* ── Objectifs & Gains ── */}
            <article className={`${CARD_BASE} md:col-span-2 relative p-7 md:p-8 flex flex-col gap-5`}>
              <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/25">
                Objectifs &amp; Gains
              </span>
            ...
            {/* ── Case Study ── */}
            <article className={`${CARD_BASE} md:col-span-3 relative p-7 md:p-9 flex flex-col gap-6`}>
              <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/25">
